<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="/dashboard"><img src="/images/Altmetric.png" alt="logo"></a>
        <a class="navbar-brand brand-logo-mini" href="/dashboard"><img src="/images/logo_mini.svg" alt="logo"></a>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-center">
        <p class="page-name d-none d-lg-block">Hi, {{ucwords(auth()->user()->name)}}</p>
        <ul class="navbar-nav ml-lg-auto">
            ...
            <li class="nav-item dropdown notification-dropdown">
                <a class="nav-link count-indicator" id="notificationDropdown" href="#" data-toggle="dropdown">
                    <i class="icon-speech icons" style="color:#0c5460">Menu</i>
                    ...
                    <a class="dropdown-item preview-item" href=""
                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <div class="preview-item-content">
                            <div class="preview-subject font-weight-medium">Logout</div>
                            <br>
